...
class OnsTwentyFourDivisions extends BoundaryProviderPluginBase implements ContainerFactoryPluginInterface {
  ...
  public function buildConfigurationForm(array $form, FormStateInterface $form_state) {
    ...
    $form['cty'] = [
      ...
      '#description' => $this->t("Local Authority County code. You can find this <a href='$cty_url'>here</a>. Use the value from the CTY24CD column."),
      '#required' => TRUE,
    ];
    ...
    $form['lad'] = [
      ...
      '#description' => $this->t("Local Authority District code. You can find this <a href='$lad_url'>here</a>. Use the value from the LAD23CD column."),
      '#required' => FALSE,
    ];
